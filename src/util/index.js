...
export const util = {
    postMessageToVsCode(data) {
        return util.getUseStore()?.postMessageToVsCode(data);
    },
    getUseStore() {
    ...
    autoScrollToBottom(listElement) {
        listElement.lastChild?.scrollIntoView({ behavior: "smooth", block: "end", inline: "nearest" });
    },
    markedParser(value) {
